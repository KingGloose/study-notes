...
## 3.20 WebSocket 和 长链接的区别

【WebSocket和长链接的区别【渡一教育】】 https://www.bilibili.com/video/BV1peCsBEEKy/?share_source=copy_web&vd_source=8992a13080c32977bce93a5140823f3b

协议不同

![[00 assets/b8959d288306dea3c4553cd64e299bda_MD5.jpeg]]
...
## 4.88 假值对象（一个对象为false）

【假值对象【渡一教育】】 https://www.bilibili.com/video/BV1v1ybBnEJq/?share_source=copy_web&vd_source=8992a13080c32977bce93a5140823f3b

![[00 assets/6ade2b28aa1423e3b344c8a60b45dce2_MD5.jpeg]]


## 4.89 ES5 来写 ES6 构造函数


## 4.90 JSON.stringify 钩子函数


## 4.91 检测对象是否循环依赖

【判断一个对象是否有循环引用（正统版）【渡一教育】】 https://www.bilibili.com/video/BV1HeCsBEEoL/?share_source=copy_web&vd_source=8992a13080c32977bce93a5140823f3b

【判断一个对象是否有循环引用（简单版）【渡一教育】】 https://www.bilibili.com/video/BV1w21pBJEEP/?share_source=copy_web&vd_source=8992a13080c32977bce93a5140823f3b


## 4.92 Map 和 Object 的区别

【Map与Object的区别【渡一教育】】 https://www.bilibili.com/video/BV1U84ZzwEr3/?share_source=copy_web&vd_source=8992a13080c32977bce93a5140823f3b

## 4.93 JS DOM 各类方法有什么区别

![](assets/八股记录/file-20260315142240680.jpg)



# 5、VueJS

## 5.1 Vue2 和 Vue3 的生命周期 / 生命周期间都做了什么

![[00 assets/a17a5bb5c208f17a1736e4b85a9e45ff_MD5.png]]

【测测看！你真的理解Vue生命周期吗？【渡一教育】】 https://www.bilibili.com/video/BV18sGgzFEBh/?share_source=copy_web&vd_source=8992a13080c32977bce93a5140823f3b


📌 **1. beforeCreate**
**数据和事件都还没初始化**
- `data`、`props`、`methods` 都还没挂载到 this
- 还没做依赖收集
- 事件系统 / watcher 系统未建立
> 主要用途：访问不到 data，适合初始化非响应式变量。

---

 📌 **2. created**
**完成响应式系统初始化**
- 初始化 `data/props/methods`，并通过 `defineReactive` 做依赖追踪
- 建立 watcher（包括渲染 watcher）
- 事件系统完成初始化
- `this` 已可访问 data/props/methods
> 此时还未挂载 DOM，因此访问不到 `$el`。

在初始化的时候，会实例化 data、methods，以及所有的调用都是从实例中拿，最终的关系链是：实例handle -> methods 中的 handle -> 外部的 handle
![](assets/八股记录/file-20251123155817612.jpg)

---

📌 **3. beforeMount**
**准备渲染，但 DOM 还没生成**
- 编译模板（compile）→ 生成 render function（如果没有 runtime-only 版本则跳过）
- 初始化渲染 watcher，但未执行初次 DOM patch

---

📌 **4. mounted**
**初次 DOM 渲染完成**
- 执行渲染 watcher，生成 VDOM
- 使用 `patch()` 生成真实 DOM
- 绑定到 `this.$el`
> 现在可以访问 DOM（例如获取元素宽高）。
...
![[00 assets/2231ae11c512b5192bcf0c7280742234_MD5.jpeg]]
![[00 assets/61c4187eff3345813dc4804c0956e860_MD5.jpeg]]
...
## 5.48 Vue3 的 Patch 算法

【vue3中patch用的是什么算法？【渡一教育】】 https://www.bilibili.com/video/BV1w21pBJEJR/?share_source=copy_web&vd_source=8992a13080c32977bce93a5140823f3b

![[00 assets/1b11d480eaf744f3a231a396e0001700_MD5.jpeg]]

### 为什么使用最长递增子序列

![[00 assets/cf7fa74cb4b0145a1fe36975b4088dbf_MD5.jpeg]]
![[00 assets/a669fbb41f1745a3f80d6fd27c5b4a89_MD5.jpeg]]

![[00 assets/ae22376fab1e4628f30b62ea39e3973c_MD5.jpeg]]

### 遍历的是真实的DOM吗

不是， VNode，他是属于一种DSL语言

### 为什么要用 VNode

架构层面：因为Vue的更新是组件层面的，如果数据的变化就需要频繁的组件更新，但是Svelte是元素层面的，所以不需要
跨平台

### 模板编译做了哪些优化

1、patchFlags 标注变化了什么
2、静态提升 提升静态节点
3、预字符串化 如果大量连续静态内容变为字符串
4、事件缓存：模板中函数缓存


## 5.49 如何实现组件同时兼容 Vue2 和 Vue3

【如何实现组件同时兼容vue2和3？【渡一教育】】 https://www.bilibili.com/video/BV1pGn1zvEAq/?share_source=copy_web&vd_source=8992a13080c32977bce93a5140823f3b

![[00 assets/817bb00f1a7d1d61fed9ca747ab0b7a0_MD5.jpeg]]

## 5.50 全局/局部注册区别

【全局注册和局部注册的区别【渡一教育】】 https://www.bilibili.com/video/BV1BGoNYbEuH/?share_source=copy_web&vd_source=8992a13080c32977bce93a5140823f3b


## 5.51 created / mounted 生命周期有什么区别
...
【白屏问题如何处理？【渡一教育】】 https://www.bilibili.com/video/BV1voqGBpEw8/?share_source=copy_web&vd_source=8992a13080c32977bce93a5140823f3b
...
![[00 assets/b53ee5a8d9f44d144687d0ee983777d6_MD5.jpeg]]
![[00 assets/0464a0933041163f6b04620f199035c2_MD5.jpeg]]
![[00 assets/b45252ea1a36e34b911282b2530f5e15_MD5.jpeg]]


## 13.44 如何优化白屏

【场景题：白屏优化【渡一教育】】 https://www.bilibili.com/video/BV1keCsBEEA9/?share_source=copy_web&vd_source=8992a13080c32977bce93a5140823f3b

首先就是如何分析什么导致的白屏：网络、渲染等，然后再来解决

## 13.45 讲讲状态机

【你知道状态机吗？【渡一教育】】 https://www.bilibili.com/video/BV1ccL7z6EwQ/?share_source=copy_web&vd_source=8992a13080c32977bce93a5140823f3b

## 13.46 如何提示用户刷新

【页面更新如何提示用户刷新？【渡一教育】】 https://www.bilibili.com/video/BV1NLoPYBEqo/?share_source=copy_web&vd_source=8992a13080c32977bce93a5140823f3b


## 13.47 防盗链依托于什么

【防盗链是依托于？【渡一教育】】 https://www.bilibili.com/video/BV1QHdJYRErx/?share_source=copy_web&vd_source=8992a13080c32977bce93a5140823f3b 

![](assets/八股记录/file-20251123162440839.jpg)

B


## 13.48 切换 tab 标签，保证 iframe 不刷新

【切换tab标签，如何保证iframe不刷新？【渡一教育】】 https://www.bilibili.com/video/BV1BkPCz7EuJ/?share_source=copy_web&vd_source=8992a13080c32977bce93a5140823f3b


## 13.49 低代码平台如何聊

【难点亮点：低代码平台该怎么聊？【渡一教育】】 https://www.bilibili.com/video/BV1mUzAB9ERi/?share_source=copy_web&vd_source=8992a13080c32977bce93a5140823f3b

![](assets/八股记录/file-20260315144328627.jpg)


## 13.50 预加载支持

【怎么实现预加载？用户体验提升之道 | 什么是渐进式ui | 实现prefetch 【白话】】 https://www.bilibili.com/video/BV1UibQzDEDR/?share_source=copy_web&vd_source=8992a13080c32977bce93a5140823f3b
...
## 18.22 webpack里面less怎么转化，less loader有什么用

![[00 assets/2c48a04cafbd65a02528332336455a27_MD5.jpeg]]
![[00 assets/44f6337ea3a82bf3ca0bb9927ab56ee3_MD5.jpeg]]
...
![[00 assets/77c67bed2f7bb36f97cf879109dbe378_MD5.jpeg]]

## 20.2 什么是二叉树？

![[00 assets/71471b1db2c3ed2ea933a5830280b3af_MD5.jpeg]]
![[00 assets/33e79eff81b5d7a73fcc10503581880d_MD5.jpeg]]

## 20.3 什么是二叉搜索树？

![[00 assets/c19379112927392fea1eb3d276754a7f_MD5.jpeg]]

## 20.4 排序有多少种？时间复杂度是多少？

![[00 assets/e21aadf16a4cc2a8f0c2c525157f81c2_MD5.jpeg]]
...
## 27.4 React生命周期，挂载阶段又有哪些函数

![[00 assets/844197b239b1fec4a330de1a1846adc4_MD5.jpeg]]


## 27.5 React Hook 可以写在组件外面吗？

![[00 assets/bf909d70934c489cc79ee05894f04d6c_MD5.jpeg]]

![[00 assets/203c92a94892287ed41c84cd63aee349_MD5.jpeg]]

## 27.6 Hook 为什么要使用链条链接起来

![[00 assets/24dad5997123a70a1021dc1f74b92e7b_MD5.jpeg]]
![[00 assets/6f6f10dfcc7a0be8372cf6eb31a0ffde_MD5.jpeg]]
![[00 assets/a5d084a05ee52125fd717466a48aad50_MD5.jpeg]]
![[00 assets/79dcc920127d48271bb6d177e0324764_MD5.jpeg]]


## 27.7 Fiber 树的遍历过程

![[00 assets/be8542c170fc48faed487340fdb8a091_MD5.jpeg]]

## 27.8 React Hook 是如何检测是否在 If 中的

【一道React Hook的面试题【渡一教育】】 https://www.bilibili.com/video/BV177xkzwE5P/?share_source=copy_web&vd_source=8992a13080c32977bce93a5140823f3b

![[00 assets/dc023be93b74183e9869ee00f8c44c93_MD5.jpeg]]
![[00 assets/656ff7d646f8be58401d438e4d884c87_MD5.jpeg]]

![[00 assets/3fa29949f0d7f45159ec0c51b113449f_MD5.jpeg]]
...
## 34.1 lint-staged / husky/ prettier / eslint 质量 / engine 字段去锁定版本 是什么

【面试拷打系列：工程化问题面试【渡一教育】】 https://www.bilibili.com/video/BV1zsAbzzEfY/?share_source=copy_web&vd_source=8992a13080c32977bce93a5140823f3b




## 34.2 单元测试的意义 / 如何测试 UI 组件
...
## 35.1 Python 和 C 的图像识别的速度区别

【Python/C++速度对比-以图像处理算法为例】 https://www.bilibili.com/video/BV17SHezYEd2/?share_source=copy_web&vd_source=8992a13080c32977bce93a5140823f3b
