...
## 1.24 请问下 border-box 和 content-box 的区别
...
1、这里的 100% 是相对于祖先块元素的内容盒部分，首先是祖先，再是块元素，然后就是内容盒。这里解释一下内容盒，margin、padding、border 不算内容盒，普通的 width 就是内容盒
...
![[00 assets/ae1834f534066d9007e4af82e3be1c88_MD5.png]]
